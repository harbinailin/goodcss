...
describe('git_remote_parser', () => {
    it.each([
        ...
        expect((0, git_remote_parser_1.parseGitRemote)(remote, 'https://gitlab.com')).toEqual({
            host,
            namespace,
            project,
        });
    ...
    it('should support self managed GitLab on a custom path', () => {
        expect((0, git_remote_parser_1.parseGitRemote)('https://example.com/gitlab/fatihacet/gitlab-vscode-extension', 'https://example.com/gitlab')).toEqual({
            host: 'example.com',
            namespace: 'fatihacet',
    ...
    it('should parse remote URLs without custom path even if the instance has custom path', () => {
        expect((0, git_remote_parser_1.parseGitRemote)('git@example.com:fatihacet/gitlab-vscode-extension.git', 'https://example.com/gitlab')).toEqual({
            host: 'example.com',
            namespace: 'fatihacet',
            project: 'gitlab-vscode-extension',
        });
    ...
    it('should parse remote URLs with ssh and custom port', () => {
        expect((0, git_remote_parser_1.parseGitRemote)('[git@example.com:2222]:fatihacet/gitlab-vscode-extension.git')).toEqual({
            host: 'example.com',
            namespace: 'fatihacet',
            project: 'gitlab-vscode-extension',
        });
...
//# sourceMappingURL=git_remote_parser.test.js.map